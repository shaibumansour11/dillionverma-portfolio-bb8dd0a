...
export const DATA = {
  ...
  contact: {
    email: "shaibumansour10@gmail.com",
    tel: "+255687157109",
    social: {
      GitHub: {
        name: "GitHub",
  ...
  work: [
    {
      ...
      description:
        "As a Web Developer at Disihub, I specialize in designing and building responsive, user-friendly websites that deliver seamless digital experiences. Leveraging my expertise in frontend and backend technologies, I collaborate with teams to create custom solutions that meet client needs and drive business growth. From concept to deployment, I ensure every project is innovative, functional, and visually appealing, helping brands establish a strong online presence.",
    },
  ...
  projects: [
    {
      title: "Marketplace",
      href: "https://ezymarket.site",
      dates: "sept 2024 - Feb 2025",
      active: true,
      description:
        "EzyMarket is an innovative online marketplace designed to connect buyers and sellers seamlessly. Built with user experience in mind, this platform offers a secure, intuitive, and responsive interface for browsing, purchasing, and selling products. From robust backend functionality to a sleek frontend design, EzyMarket simplifies e-commerce, making it easier for users to trade and businesses to grow. This project showcases my ability to create scalable, user-centric solutions that bridge technology and real-world need",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
